...
run_once({ "urxvtd", "unclutter -root", "nm-applet &", "blueman-applet &" }) -- comma-separated entries
...
local my_theme     = require("./themes/" .. chosen_theme .. "/theme")

awful.util.terminal = terminal
-- awful.util.tagnames = { "1", "2", "3", "4", "5" }

local tagnames = { "Kitty", "Neovim", "Git", "Firefox", "Steam", "Discord", "Thunar", "Other" }
-- awful.util.tagnames = tagnames

for i, v in pairs(tagnames) do
    awful.tag.add("", {
        icon              = os.getenv("HOME") .. "/.config/awesome/green-icons/" .. v .. ".svg",
...
root.buttons(mytable.join(
    ...
    awful.button({}, 4, screen[1].tags.viewnext),
    awful.button({}, 5, screen[1].tags.viewprev)
))
...
--widget keys
    awful.key({}, "XF86AudioRaiseVolume", function() my_theme.volume_widget:inc(5) end,
        { description = "raise volume", group = "custom" }),
    awful.key({}, "XF86AudioLowerVolume", function() my_theme.volume_widget:dec(5) end,
        { description = "lower volume", group = "custom" }),
    awful.key({}, "XF86AudioMute", function() my_theme.volume_widget:toggle() end,
        { description = "mute volume", group = "custom" }),


    awful.key({}, "XF86MonBrightnessUp", function() my_theme.brightness_widget:inc() end,
        { description = "increase brightness", group = "custom" }),
    awful.key({}, "XF86MonBrightnessDown", function() my_theme.brightness_widget:dec() end,
    ...
    -- -- Tag browsing
    -- awful.key({ modkey, }, "h", screen[1].tags.viewprev,
    --     { description = "view previous", group = "tag" }),
    -- awful.key({ modkey, }, "l", screen[1].tags.viewnext,
    --     { description = "view next", group = "tag" }),
    --NOTE: below errors but should be fixed
    -- awful.key({ modkey,           }, "Escape", screen[1].tags.history.restore,
    ...
    awful.key({ modkey, altkey }, "l", function() screen[1].tags.incmwfact(0.05) end,
        { description = "increase master width factor", group = "layout" }),
    awful.key({ modkey, altkey }, "h", function() screen[1].tags.incmwfact(-0.05) end,
        { description = "decrease master width factor", group = "layout" }),
    awful.key({ modkey, "Shift" }, "h", function() screen[1].tags.incnmaster(1, nil, true) end,
        { description = "increase the number of master clients", group = "layout" }),
    awful.key({ modkey, "Shift" }, "l", function() screen[1].tags.incnmaster(-1, nil, true) end,
        { description = "decrease the number of master clients", group = "layout" }),
    awful.key({ modkey, "Control" }, "h", function() screen[1].tags.incncol(1, nil, true) end,
        { description = "increase the number of columns", group = "layout" }),
    awful.key({ modkey, "Control" }, "l", function() screen[1].tags.incncol(-1, nil, true) end,
    ...
    awful.key({ altkey }, "f", function() awful.spawn(fileManager) end, {
